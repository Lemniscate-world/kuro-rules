...
> [!IMPORTANT]
> This file is a **Redirector**. It does not contain the full ruleset to optimize AI context usage.
> All rules are stored as individual modules in the `rules/` directory.

## Startup Sequence
1. Confirm: "I have read AGENTS.md and will enforce all rules."
2. Load modules from `rules/` as needed by the current task.

## Key Modules
- [Foundation](file:///c:/Users/Utilisateur/Documents/kuro-rules/rules/rule_01_foundation.md) (Always Load)
...
---
Last updated: 2026-05-05 | System: Kuro Section-9
