...
| **Astral** |  45%  | Actif | Multi-repo intelligence avec client Hindsight. Data Gravity moat implémenté, Next.js MVP. |
...
| **TokenWise** |  30%  | Prototypage | Analyse et réduction du coût par tokens utilisés. Phase validation Mom Test. |
...
| **Automatons** |  30%  | Prototypage | Agent orchestration and automation framework. |
...
| Projet | Progression | Statut | Description |
|--------|-------------|--------|-------------|
| **EchoX** |  47%  | Actif | SRS avec forgetting curves (PyQt6). Validation L1 complète ($23.9B marché), GUI desktop opérationnelle. 6 tests. Structure Tauri initialisée. |
...
| Projet | Progression | Statut | Description |
|--------|-------------|--------|-------------|
| **Dissect** |  60%  | Actif | Outil d'audit et de visualisation de l'orchestration des agents IA. 9 tests, branch: main. |
