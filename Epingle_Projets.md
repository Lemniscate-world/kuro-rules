...
| **Astral** |  35%  | Actif | Multi-repo intelligence avec client Hindsight. Data Gravity moat implémenté, Next.js MVP. |
...
| **TokenWise** |  20%  | Prototypage | Analyse et réduction du coût par tokens utilisés. Phase validation Mom Test. |
...
| **Automatons** |  20%  | Prototypage | Agent orchestration and automation framework. |
...
| Projet | Progression | Statut | Description |
|--------|-------------|--------|-------------|
| **OpenQuant** |  74%  | Actif | Trading quantitatif avec MiroFish (swarm LLM). 18+ fichiers de test, backtest harness + 1-year Gold validation, NewsAPI integre. v0.3.0-kuro. Phase 4 backtest complete. |
...
| Projet | Progression | Statut | Description |
|--------|-------------|--------|-------------|
| **Dissect** |  50%  | Actif | Outil d'audit et de visualisation de l'orchestration des agents IA. 9 tests, branch: main. |
